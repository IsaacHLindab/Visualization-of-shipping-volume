...
Overview of steps:
Aquire domain knowledge of Lindabs databases and transport process Aquire permissions to TM and data related to the transport process Implement a simplifed database of packaged item and truck data from Rasmus kolli sheet. Develop the visualization tool Gain feedback on visualization test from Control Tower Introduce suggestion of loading into the visualization Gain feedback on test from transport office in Profil Förslöv and Control Tower Apply improvments from feedback Forward visualization down the supply chain

Overview of sprints:
Sprint 1 - Research and POC Sprint 2 - Steering group meeting Sprint 3 - Basic visualization tool Sprint 4 - Connect to real time data Sprint 5 - Implement loading suggestions Sprint 6 - Go live in Control Tower Sprint 7 - Go live in Transport Office (Sweden) Sprint 8 - Prep for AI/ML assistant More detailed overview of sprints can be found in teams "original overview of agile planning.png"
